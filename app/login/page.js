...
import { FaEye, FaEyeSlash, FaGoogle, FaCube } from 'react-icons/fa';
                ...
                <div className="w-full max-w-[480px] bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-[#e7ebf3] dark:border-gray-800 p-8">
                    ...
                    <form className="space-y-4" onSubmit={handleLogin}>
                        ...
                        <button
                            ...
                            type="button"
                            onClick={() => Swal.fire('Coming Soon', 'Social login is coming soon.', 'info')}
                        >
                    ...
                    <p className="text-center mt-6 text-sm text-[#4c669a] dark:text-gray-400">
                        New to ProductHub? <Link className="text-primary font-bold hover:underline" href="/register">Create an account</Link>
                    </p>
                </div>
            </main>
...
export default function LoginPage() {
    return (
        <Suspense fallback={
            <div className="min-h-screen flex items-center justify-center bg-[#f8f9fc] dark:bg-background-dark">
